...
class  Member extends BaseModel
{
    ...
    public function register($register_info)
    {
        ...
        if ($insert_id) {
            ...
            $bonus = $bonus_model->getOneBonus(array(array('bonus_type' ,'=', 2), array('bonus_state' ,'=', 1), array('bonus_begintime','<', TIMESTAMP), array('bonus_endtime','>', TIMESTAMP)));
            if ($bonus) {
                //获取未领取单个红包
                $condition = array();
                $condition[] = array('bonus_id','=',$bonus['bonus_id']);
