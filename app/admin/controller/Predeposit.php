...
class  Predeposit extends AdminControl {
    ...
    public function pdrecharge_list() {
        ...
        if ($start_unixtime || $end_unixtime) {
            $condition[]=array('pdr_addtime','between', array($start_unixtime, $end_unixtime));
        }
    ...
    public function pdlog_list() {
        ...
        if ($start_unixtime || $end_unixtime) {
            $condition[]=array('lg_addtime','between', array($start_unixtime, $end_unixtime));
        }
    ...
    public function pdcash_list() {
        ...
        $end_unixtime = $if_end_date ? strtotime($etime) : null;
        if ($start_unixtime || $end_unixtime) {
            $condition[] = array('pdc_addtime','between', array($start_unixtime, $end_unixtime));
        }
        $mname = input('get.mname');
        if (!empty($mname)) {
