...
class SellerO2oOrderBill extends BaseSeller {
    ...
    public function initialize() {
        parent::initialize();
        Lang::load(base_path() . 'home/lang/' . config('lang.default_lang') . '/seller_o2o_order_bill.lang.php');
    }
    ...
    public function pay_bill() {
        ...
        if (request()->isPost()) {
            ...
            if (!empty($_FILES['file']['name'])) {
                $upload_file = BASE_UPLOAD_PATH . DIRECTORY_SEPARATOR . ATTACH_STORE . DIRECTORY_SEPARATOR . $bill_info['store_id'] . DIRECTORY_SEPARATOR . 'o2o_order_bill';
            ...
            return View::fetch($this->template_dir . 'bill_pay');
        }
    }
