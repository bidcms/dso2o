...
class  Statisticsgoods extends BaseSeller
{
    ...
    public function index(){
        ...
        if($this->choose_gcid > 0){
            ...
            $condition[] = array('gc_parentid_'.$gc_depth,'=',$this->choose_gcid);
        }
        if(trim(input('param.search_gname'))){
            $condition[] = array('goods_name','like',"%".trim(input('param.search_gname'))."%");
        }
        //查询总条数
        $count_arr = $stat_model->statByStatordergoods($condition, 'count(DISTINCT goods_id) as countnum');
        ...
        $stat_ordergoods = $stat_model->statByStatordergoods($condition, $field, array(5,$countnum), 0, $this->search_arr['orderby'], 'goods_id');
    ...
    public function goodsinfo(){
        ...
        if ($goods_id <= 0){
            ...
            echo View::fetch($this->template_dir.$templatesname);exit;
        }
        //查询商品信息
        ...
        $stat_ordergoods = $stat_model->statByStatordergoods($condition, $field, 0, 0, '','');
