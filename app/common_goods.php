...
function sns_thumb($image_name = '', $type = '')
{
    ...
    $file_path = ATTACH_MALBUM . DIRECTORY_SEPARATOR . $member_id . DIRECTORY_SEPARATOR . $image_name;
...
function pointprod_thumb($image_name = '', $type = '')
{
    ...
    $file_path = ATTACH_POINTPROD . DIRECTORY_SEPARATOR . $image_name;

    if (!file_exists(BASE_UPLOAD_PATH . DIRECTORY_SEPARATOR . $file_path)) {
        return UPLOAD_SITE_URL . '/' . default_goodsimage('normal');
    }
    return UPLOAD_SITE_URL . '/' . $file_path;
}
...
{
    if (file_exists(BASE_UPLOAD_PATH . DIRECTORY_SEPARATOR . ATTACH_COMMON . DIRECTORY_SEPARATOR . 'category-pic-'.$cate_id.'.jpg')) {
