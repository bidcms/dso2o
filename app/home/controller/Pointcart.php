...
class  Pointcart extends BasePointShop
{
    ...
    public function step1(){
        ...
        //实例化收货地址模型（不显示自提点地址）
        $address_list = model('address')->getAddressList(array(array('member_id','=',session('member_id')),array('address_o2o_errand_type' ,'=', 0)), 'address_is_default desc,address_id desc');
